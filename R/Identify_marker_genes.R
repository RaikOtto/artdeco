...
#' @param training_nr_marker_genes Number of desired marker genes to describe 
#' a subtype.
...
identify_marker_genes = function(
    ...
    colnames(result_t) = c("Log_FC","Average_Expr","t","P_value",
                           "adj_P_value","B","HGNC")

    result_t = result_t[c("HGNC","Log_FC","Average_Expr","P_value",
                          "adj_P_value")]
    ...
    marker_genes = marker_genes[marker_genes %in% 
                                    rownames(expression_training_mat)]
